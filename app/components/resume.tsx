  ...
  return (
    <>
      <a
        ...
        download
        className="group bg-[url('/images/cvPic.png')] bg-cover shadow-inner hover:shadow-slate-700 hover:scale-[101%] hover:bg-gray-700 duration-300 shadow-black bg-center bg-blend-soft-light h-[38vh] rounded-2xl m-10 border-0 border-amber-500 border-opacity-90 min-w-[300px] cursor-pointer active:bg-gray-800"
      >
