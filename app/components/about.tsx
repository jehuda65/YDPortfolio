...
const About = () => (
  <Dialog.Root>
    <Dialog.Trigger asChild>
      <div className="group cursor-none bg-[url('/images/cvPic.png')] bg-cover shadow-inner hover:shadow-slate-700 hover:scale-[101%] hover:bg-gray-700 duration-300 shadow-black bg-center bg-blend-soft-light h-[38vh] w-1/3 rounded-2xl  border-0 border-amber-500 border-opacity-90 min-w-[300px] active:bg-gray-800">
    ...
    <Dialog.Portal>
      ...
      <Dialog.Content className="z-[100] text-white data-[state=open]:animate-contentShow fixed inset-[7%] rounded-lg bg-gradient-to-tr from-amber-400 to-zinc-400  p-1 flex flex-col items-center shadow focus:outline-none lg:animate-[fadeInAbout_0.5s_ease-in-out]">
        <div className="dialog-content overflow-y-scroll rounded-lg z-20  p-1 backdrop-blur-lg cursor-none bg-zinc-800/80 h-full w-full">
