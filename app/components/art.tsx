...
const Art = () => (
  <Dialog.Root>
    <Dialog.Trigger asChild>
      <div className="z-10 group bg-[url('/images/finkel.jpg')] bg-cover shadow-inner hover:shadow-slate-700 hover:scale-[101%] hover:bg-gray-700 duration-300 shadow-black bg-center bg-blend-soft-light h-[38vh] rounded-2xl  border-0 border-amber-500 border-opacity-90 min-w-[300px] active:bg-gray-800">
        <div className="bg-gradient-to-b from-gray-800 rounded-t-2xl group-hover:bg-none">
    ...
    <Dialog.Portal>
      ...
      <Dialog.Content className="z-[100] text-white data-[state=open]:animate-contentShow fixed inset-[7%] rounded-lg bg-gradient-to-tr from-amber-400 to-zinc-400  p-1 flex flex-col items-center shadow focus:outline-none lg:animate-[fadeInArt_0.5s_ease-in-out]">
